...
<td><a href="<?php echo base_url('/Welcome/edit_view')?>?id=<?php echo $post->itemId?>">Edit Item</a></td>
<td><a href="<?php echo base_url('/Welcome/delete_view')?>?id=<?php echo $post->itemId?>">Delete Item</a></td>
</tr>
<?php
}
?>
